...
Overall, it seems that the pandemic did not have an impact on robbery incidents, with a decrease during the Pre-pandemic phase and an increase during the Lockdown phase. However, it is also important to note that robbery incidents increased again during the Post-pandemic phase.
...
In the pre-pandemic period, the frequency of robberies was lower compared to the overall period, and the distribution among the days of the week was more even, with Sunday having the highest frequency of 395 incidents, and Wednesday having the lowest frequency of 330 incidents.

During the lockdown period, the frequency of robberies increased compared to the pre-pandemic period, with Monday having the highest frequency of 450 incidents, and Friday having the lowest frequency of 344 incidents.

In the post-pandemic period, the frequency of robberies continued to increase compared to the previous period, with Monday having the highest frequency of 485 incidents and Tusday having the lowest frequency of 411 incidents. Monday and Sunday remained two of the days with a high frequency of robberies, with 485 and 476 incidents reported.
...
```
  ...
  + **So, we can to reject $H_0$ at the 95% significance level and spport the alternative hypothesis. **
...
```
  ...
  + **So, we can to reject $H_0$ at the 95% significance level and support the alternative hypothesis. **
 
### 2.Period_cat ~ Period_cat_2

  +  Null hypothesis: $H_0:$ Period_cat (pre, lock, post) and period_cat_2(weekday, weekend) are independent
