...
cols <- c('Period_cat','Period_cat_2','Month_2','Season','Date_cat','Day_cat_2','SHIFT','METHOD')
...
#Summary
#columns to analyse 
cols <- c('Period_cat','Period_cat_2','Year', 'Month','Month_2',
...
#Avg
temp[1,3] = as.integer(temp[1,2] / 17 ) #post: 16M  
...
#pre
plot_Month_pre <- ggplot(data=Robbery_pre, aes(x=Month_2)) +
geom_bar(colour="darkblue", fill="lightblue",alpha = .7) +
geom_text(stat='count', aes(label=..count..),vjust = 1.5) + #vjust:lable position
  labs(x="Month") + labs(title="A2-2.Monthly Robbery (Pre)")

#lock
plot_Month_lock <- ggplot(data=Robbery_lock, aes(x=Month_2)) +
geom_bar(colour="darkblue", fill="lightblue",alpha = .7) +
geom_text(stat='count', aes(label=..count..),vjust = 1.5) + #vjust:lable position
  labs(x="Month") + labs(title="A2-3.Monthly Robbery (Lock)")

#post
plot_Month_post <- ggplot(data=Robbery_post, aes(x=Month_2)) +
geom_bar(colour="darkblue", fill="lightblue",alpha = .7) +
geom_text(stat='count', aes(label=..count..),vjust = 1.5) + #vjust:lable position
  labs(x="Month") + labs(title="A2-4.Monthly Robbery (Post)")
...
```{r}
temp <- count(Robbery,Season, sort=TRUE) 
temp
```
```{r}
temp <- count(Robbery_post,Season, sort=TRUE) #fall, summer, winter, spring
temp
```
...
#Total
temp <- count(Robbery,Season, sort=TRUE) #fall, summer, winter, spring

#total_Avg
temp[1,3] = as.integer(temp[1,2] / 12) #fall 
temp[2,3] = as.integer(temp[2,2] / 12) #summer
temp[3,3] = as.integer(temp[3,2] / 12) #winter 
temp[4,3] = as.integer(temp[4,2] / 12) #spring 

x <-  c("SPRING","SUMMER","AUTUMN","WINTER")
y  <-  c(temp[4,3],temp[2,3],temp[1,3],temp[3,3] )
...
plot_Season <- ggplot(data=temp_2, aes(x,y)) + 
  ...
  labs(title="B1.Seansonally Robbery frequency") + scale_x_discrete(limits=c("SPRING","SUMMER","AUTUMN","WINTER")) + geom_text(aes(label=signif(y)),vjust = 1.5)   

#########Pre
temp <- count(Robbery_pre,Season, sort=TRUE) #fall, summer, winter, spring

#pre-pen
temp[1,3] = as.integer(temp[1,2] / 5) #winter
temp[2,3] = as.integer(temp[2,2] / 3) #fall
temp[3,3] = as.integer(temp[3,2] / 3) #summer
temp[4,3] = as.integer(temp[4,2] / 3) #spring 

x <-  c("SPRING","SUMMER","AUTUMN","WINTER")
y  <-  c(temp[4,3],temp[3,3],temp[2,3],temp[1,3] )
...
plot_Season_pre <- ggplot(data=temp_2, aes(x,y)) + 
  geom_bar(col="darkblue", 
                 ...
                 alpha = .7,stat='identity') + 
  labs(x="Season", y="Avg.Robbery") +
  labs(title="B1_1.Seasonly Robbery (Pre)") + scale_x_discrete(limits=c("SPRING","SUMMER","AUTUMN","WINTER")) + geom_text(aes(label=signif(y)),vjust = 1.5)   


######Lock
temp <- count(Robbery_lock,Season, sort=TRUE) #fall, summer, winter, spring

#lock-pen
temp[1,3] = as.integer(temp[1,2] / 5) # summer
temp[2,3] = as.integer(temp[2,2] / 3) # fall
temp[3,3] = as.integer(temp[3,2] / 6) # spring
temp[4,3] = as.integer(temp[4,2] / 3) # winter

x <-  c("SPRING","SUMMER","AUTUMN","WINTER")
y  <-  c(temp[3,3],temp[1,3],temp[2,3],temp[4,3] )
...
plot_Season_lock <- ggplot(data=temp_2, aes(x,y)) + 
  geom_bar(col="darkblue", 
                 ...
                 alpha = .7,stat='identity') + 
  labs(x="Season", y="Avg.Robbery") +
  labs(title="B1_2.Seasonly Robbery (Lock)") + scale_x_discrete(limits=c("SPRING","SUMMER","AUTUMN","WINTER")) + geom_text(aes(label=signif(y)),vjust = 1.5)   

#########Post
temp <- count(Robbery_post,Season, sort=TRUE) #fall, summer, winter, spring

#post-pen
temp[1,3] = as.integer(temp[1,2] / 6) #fall 
temp[2,3] = as.integer(temp[2,2] / 4) #winter
temp[3,3] = as.integer(temp[3,2] / 4) #summer
temp[4,3] = as.integer(temp[4,2] / 3) #spring 

x <-  c("SPRING","SUMMER","AUTUMN","WINTER")
y  <-  c(temp[4,3],temp[3,3],temp[1,3],temp[2,3] )
...
plot_Season_post <- ggplot(data=temp_2, aes(x,y)) + 
  geom_bar(col="darkblue", 
                 ...
                 alpha = .7,stat='identity') + 
  labs(x="Season", y="Avg.Robbery") +
  labs(title="B1_3.Seasonly Robbery (Post)") + scale_x_discrete(limits=c("SPRING","SUMMER","AUTUMN","WINTER")) + geom_text(aes(label=signif(y)),vjust = 1.5) 
...
```{r}
table = table(Robbery$Period_cat, Robbery$SHIFT)
table
...
```{r}
table = table(Robbery$Period_cat, Robbery$Season)
table
chitest = chisq.test(table)
chitest
```
...
```{r}
table = table(Robbery$Period_cat, Robbery$Day_cat_2)
table
chitest = chisq.test(table)
chitest
```
...
```{r}
table = table(Robbery$Period_cat, Robbery$METHOD)
table
chitest = chisq.test(table)
chitest
```
...
```{r}
table = table(Robbery$Period_cat, Robbery$Month)
table
chitest = chisq.test(table)
chitest
```
...
```{r}
table = table(Robbery$Period_cat, Robbery$DISTRICT)
table
chitest = chisq.test(table)
chitest
```
