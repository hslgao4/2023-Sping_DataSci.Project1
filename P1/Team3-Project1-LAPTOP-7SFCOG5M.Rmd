...
There was a total of 8,343 robbery incidents during the period, with 2,535 incidents recorded in the pre-lockdown period and 3,079 incidents in the post-lockdown period. The mean clearance rate for robbery incidents was 215 minutes, which indicates that it took about 3 hours to clear the incidents (an arrest or closure). There were some missing values in the data set, with 1701 instances of “NA” recorded in the “Clearance_rate” column, which means the proportion uncleared robbery incidents that have no value of clearance rate is about 21%. And 21 and 22 instances of “NA” recorded in the “DISTRICT” and “PSA” columns, respectively.
...
The four charts, B1_4 to B1_7, display the average number of robberies per month in each season for the years 2019 to 2022. These charts reveal that the average number of robberies per month varied across different years and seasons. The highest averages were not consistently in the same season or year.
...
**8-1. Freq by METHOD :split by pandemic phrases(Avg.Robbery(per month)**
  ...
  + The data show that **the portion of gun robberies increased significantly from 34.2% in the pre-pandemic period to 51.7% in the lockdown period and further to 56.9% in the post-pandemic period.**
...
prop.1 <- with(Robbery, table(Period_cat, METHOD)) %>% 
          prop.table(margin = 1)
