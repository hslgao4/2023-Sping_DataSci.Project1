...
1. Target_Clearance_time: whether Longer time or not 
...
#PIVOT with Target
#prop.1 <- with(model_1_clean, table(SHIFT, Clearance_rate)) %>% 
...
#PIVOT with Target
#prop.1 <- with(model_1_clean, table(Target_Clearance_time_f, Target_clr_gun)) %>% 
#          prop.table(margin = 1)  #Percent
#prop.1*100
```
...
```{r}
pairs.panels(model_2_clean[,c(2,13:20)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,21:30)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,31:40)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,41:50)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,51:60)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,61:70)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,71:80)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_2_clean[,c(2,81:88)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
