...
```{r}
col_org <- c('Date_cat','Day_cat','Day_cat_2','DISTRICT','Month','Period_cat_num_2','Season','SHIFT','METHOD','Clearance_rate','Target_Clearance_time','Target_Clearance_time_2','Target_robbery_method')
...
```{r}
cols <- c('Date_cat','Day_cat_2','Season','SHIFT','METHOD','Period_cat_num_2','Target_Clearance_time','Target_Clearance_time_2','Target_robbery_method')  #array
Robbery_clean_p2_add %<>%
...
```{r}
model_1 <-  subset(Robbery_clean_p2_model, Target_Clearance_time_2 == 0 |Target_Clearance_time_2 == 1)
...
Data: model_1_clean
Target: `Target_Clearance_time` , (temp) `Target_Clearance_time_2`
...
pairs.panels(model_1_clean[,c(1:10)],   #[,c(2:7,9:10)]
...
```{r}
pairs.panels(model_1_clean[,c(1,11:20)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,21:30)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,31:40)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,41:50)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,51:60)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,61:70)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,71:80)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
```{r}
pairs.panels(model_1_clean[,c(1,81:88)],   #Target, Census [,c(2:7,9:10)]
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = FALSE,  # show density plots
             ellipses = FALSE # show correlation ellipses
...
temp <- data.frame(x = model_1_clean$DISTRICT,
                 y = as.numeric(model_1_clean$Target_Clearance_time))
...
```{r}
#Other way: Pivot Table: Cate(x) x Cate(target), if # of category is small
prop.1 <- with(model_1_clean, table(SHIFT, Target_Clearance_time)) %>% 
          prop.table(margin = 1)  #Percent
...
```{r}
#Other way: Pivot Table: Cate(x) x Cate(target), if # of category is small
prop.1 <- with(model_1_clean, table(Period_cat_num_2, Target_Clearance_time)) %>% 
          prop.table(margin = 1)  #Percent
...
temp <-  model_1_clean %>% group_by(SHIFT,DISTRICT) %>%
                   summarise(avg = mean( as.numeric(Target_Clearance_time), na.rm = TRUE),.groups = 'drop')
...
```{r}
contable = table(model_1_clean$DISTRICT, model_1_clean$Target_Clearance_time)
...
ggplot(model_1_clean, aes(hs_200000__pct, fill = Target_Clearance_time)) +  geom_histogram(alpha = 0.5, aes(y = ..density..), position = 'identity')
ggplot(model_1_clean, aes(hs_200000__pct, fill = Target_Clearance_time)) + geom_density(alpha = 0.2)
...
```{r}
t0 = subset(model_1_clean,Target_Clearance_time=='0')
t1 = subset(model_1_clean,Target_Clearance_time=='1')
...
ggplot(model_1_clean, aes(pct_all_families_below_poverty, fill = Target_Clearance_time)) +  geom_histogram(alpha = 0.5, aes(y = ..density..), position = 'identity')
ggplot(model_1_clean, aes(pct_all_families_below_poverty, fill = Target_Clearance_time)) + geom_density(alpha = 0.2)
...
ggplot(model_1_clean, aes(worked_from_home_pct, fill = Target_Clearance_time)) +  geom_histogram(alpha = 0.5, aes(y = ..density..), position = 'identity')
ggplot(model_1_clean, aes(worked_from_home_pct, fill = Target_Clearance_time)) + geom_density(alpha = 0.2)
...
ggplot(model_1_clean, aes(Production_transportation_and_material_moving_occupations_pct, fill = Target_Clearance_time)) +  geom_histogram(alpha = 0.5, aes(y = ..density..), position = 'identity')
ggplot(model_1_clean, aes(Production_transportation_and_material_moving_occupations_pct, fill = Target_Clearance_time)) + geom_density(alpha = 0.2)
...
Logit_model_2 <- glm(Target_Clearance_time_2 ~ DISTRICT + Period_cat_num_2 + SHIFT + Income_mean  + pct_all_families_below_poverty + worked_from_home_pct , data = data_train_model_1, family = "binomial")
...
cm_info <- ConfusionMatrixInfo( data = data_test_model_1, predict = "prediction", 
                                actual = "Target_Clearance_time_2", cutoff = .55 )
...
```{r}
#exclude vars that p-value is not significant 
Logit_model_gun <- glm(Target_robbery_method ~ DISTRICT + Period_cat_num_2 + SHIFT + Season, data = data_train_model_2, family = "binomial")
...
cm_info <- ConfusionMatrixInfo( data = data_test_model_2, predict = "prediction", 
                                actual = "Target_robbery_method", cutoff = .4 )
...
Regardless of a cutoff level, the AUROC(area-under-curve) is 0.773, which is less than 0.8. The model does not seem to make the best good predict power.
